...
r4 <- rast("~/projects/def-mfortin/georod/data/reclassed_copernicus/reclassed_copernicus_v2.tif")
...
for (k in 1:length(city)) {
  ...
  # Project to Europe (web-mercator 3387) raster projection
  ...
  ### rclM <- as.matrix(cecRes[,c(3,7)]) #Europe
