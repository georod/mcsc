...
-- Add buffer here not in csv file
UPDATE seattle3_env SET geom = st_buffer(st_transform(ST_MakeEnvelope(-122.423911576421, 47.4169708269983, -121.945288423579, 47.7540498395082, 4326), 3857),10000) WHERE sid=1;
