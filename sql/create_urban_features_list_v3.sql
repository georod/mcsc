...
-- Main aim: Union all SQL VIEWS to create a master list of city features. In this version this code will be run for each city.
-- Note: This code is no longer run on its own. Using a list of PG view names, this code is run for each city within R. See features_to_lcover_v4.R
-- 
...
COMMENT ON TABLE urban_features_v1 IS 'Master list of features defined. [2023-06-19]';